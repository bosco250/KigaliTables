    ...
    <div className="flex items-center sm:gap-5 gap-2 bg-gray-200 text-gray-800 p-4  rounded-md">
      <div className="flex items-center sm:gap-5 gap-3">
        <div className="flex items-center sm:gap-2 gap-1">
          ...
          <span className="sm:text-xl text-[14px]">Nov 25, 2024</span>
        </div>
        <ChevronDown />
      </div>
      <div className="flex items-center sm:gap-5 gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="md:text-xl text-[14px]"> 12:00 AM</span>
        </div>
        <ChevronDown />
      </div>
      <div className="flex items-center sm:gap-5 gap-3">
        <div className="flex  sm:gap-2 gap-1">
          ...
          <span className="sm:text-xl text-[14px]">3 People</span>
        </div>
        <ChevronDown />
      </div>
    </div>
